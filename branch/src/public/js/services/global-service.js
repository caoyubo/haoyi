  ...
  this.$get = function($http, $q , baseService) {
    return {
      ...
      commonGet: function(url,data){
        console.log(grobalUrl.url+url);
        return baseService.webRequest(grobalUrl.url+url,data,requestMethod.GET);
      },
      ...
      commonPost: function(url,data){
        console.log(grobalUrl.url+url);
        return baseService.webRequest(grobalUrl.url+url,data,requestMethod.POST);
      }
